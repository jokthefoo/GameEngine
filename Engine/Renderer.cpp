...
void Engine::Renderer::Shutdown()
{
	for (int i = 0; i < spriteList.Count(); i++)
	{
		...
		GLib::Sprites::Release(objR.sprite);
	}
	spriteList.DeleteList();
}

void Engine::Renderer::RenderSprites()
{
...
Engine::Renderer::ObjectRenderer::ObjectRenderer() :
	obj(NULL), sprite(NULL)
{
}

Engine::Renderer::ObjectRenderer::ObjectRenderer(GameObject * p_obj, GLib::Sprites::Sprite *spr) :
	obj(p_obj), sprite(spr)
{
	spriteList.Add(*this);
}